...
public abstract class DAOAbstractJDBC<T> implements DAOInterfaceJDBC<T> {
    ...
    ResourceBundle resourceBundleConnection = ResourceBundle.getBundle("Configurate") ;
    ...
    public T create(T object) {
        ...
        try (PreparedStatement statement = getConnection().prepareStatement(sql)) {
            ...
            if ((list == null) || (list.size() != 1)) {
                throw new DAOException("com.kazhamiakina.Model.DAO.Exception on findByPK new persist data.");
            }
